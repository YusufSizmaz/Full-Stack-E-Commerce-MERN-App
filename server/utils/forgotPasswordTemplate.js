const forgotPasswordTemplate = ({ name, otp }) => {
  return `
        ...
        <head>
            ...
            <style>
                body {
                    ...
                    background-color: #fff8dc; /* Sarı tonları */
                    margin: 0;
                    padding: 0;
                }
                .container {
                    ...
                    text-align: center;
                    border: 1px solid #d69e2e; /* Sarı tonları */
                }
                .icon {
                    width: 80px;
                    height: 80px;
        ...
        <body>
            <div class="container">
                <img src="https://your-logo-url.com/logo.png" class="icon" alt="Password Reset Icon"> <!-- Logonuzu buraya ekleyin -->
